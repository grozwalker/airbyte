...
import pytest
from source_vk_ads_2.source import VkAds_2Stream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(VkAds_2Stream, "path", "v0/example_endpoint")
    mocker.patch.object(VkAds_2Stream, "primary_key", "test_primary_key")
    mocker.patch.object(VkAds_2Stream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = VkAds_2Stream()
